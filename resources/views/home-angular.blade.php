...
<div class="container">
  ...
  <div class="row">
    ...
    <ul class="nav nav-tabs" role="tablist" id="myTab">
      ...
      <li role="presentation"><a href="#concursos-publicos" aria-controls="concursos-publicos" role="tab" data-toggle="tab">Concursos y designaciones</a></li>
    </ul>
      ...
      @if(count($objProfile))
        ...
        @foreach($objProfile as $profile)
            ...
            <div class="col-md-3" >
              ...
              <label class="align-c president-label">{{$profile->name }} {{$profile->lastname }}</label><br>
              <label class="align-c president-label">{{ strip_tags($profile->description)}}</label><br>
